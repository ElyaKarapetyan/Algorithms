...
void validNumber(int& number) {
    while (std::cin.fail()) {
        std::cout << "\n\nInvalid Value: Try again!" << std::endl;
        std::cin.clear();
        std::cin.ignore(256,'\n');
...
void chooseFunction(Queue& myQueue) {
    ...
    int index = 0;
    int value = 0;
    std::cout << "\nPlease choose on of the following functions\n" << std::endl;
    while (0 != check) {
        switch (check) {
            case 0:
                return;
            ...
            case 6:
                ...
                break;
            case 7:
                std::cout << "\nSize of queue: " << myQueue.size() << std::endl << std::endl;
                break;
        }
...
int main() {
    int size = 0;
    do {
        std::cout << "Enter the size of the Queue (> 0): ";
        std::cin >> size;
        std::cin.clear();
        std::cin.ignore(256,'\n');
